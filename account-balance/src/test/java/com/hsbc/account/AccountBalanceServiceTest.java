...
public class AccountBalanceServiceTest {
    ...
    public void testQueryAccountBalance_ShouldReturnAccountBalance() {
        ...
        // Act
        AccountBalance result = accountBalanceService.queryAccountBalance(String.valueOf(accountId));
    ...
    public void testQueryAccountBalance_ShouldThrowExceptionWhenAccountNotFound() {
        ...
        // Act & Assert
        Exception exception = assertThrows(EntityNotFoundException.class, () -> accountBalanceService.queryAccountBalance(String.valueOf(accountId)));
